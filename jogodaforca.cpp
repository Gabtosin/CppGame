...
int jogar(int numeroDeJogadores){
    ...
    int cont = 0;                                           //Auxiliar para laços de repetições
    ...
    while(palavra != palavraComMascara && maximoDeTentativas - tentativas > 0){
        ...
        if(jaDigitouLetra == false){
            ...
            if(acertouLetra == false){
                ...
                mensagem = "Vc errou uma letra!";

            }else{

                mensagem = "Vc acertou uma letra!";
...
void menuInicial(){
    ...
    //Opções escolhida pelo user
    int opcao = 0;

    //Enquanto o jogador não digita uma opcao válida, mostra o menu de novo
    while(opcao < 1 || opcao > 3){
        ...
        switch(opcao){
            ...
            case 3:
                ...
                limpaTela();
                cout << "Jogo criado por Gabriel Tosin";
                cout << "\n1 - Voltar";
                cout << "\n2 - Sair";
                cin >> opcao;
                if(opcao == 1){
...
int main(){
    ...
    //Para gerar números realmente aleatrios
